    ...
    public function post_meta_1($post)
    {
        ...
        if(get_theme_mod('jnews_show_block_meta', true))
        {
            ...
            if( jnews_is_review($post->ID) )
            {
                ...
                $output .= get_theme_mod('jnews_show_block_meta_author', true) ? "<div class=\"jeg_meta_author\"><span class=\"by\">" . jnews_return_translation('by', 'jnews', 'by') . "</span> " . tsd_get_coauthors_link_for_post($post) . "</div>": "";
                $output .= "</div>";
            } else {
                $output .= "<div class=\"jeg_post_meta\">";
                $output .= get_theme_mod('jnews_show_block_meta_author', true) ? "<div class=\"jeg_meta_author\"><span class=\"by\">" . jnews_return_translation('by', 'jnews', 'by') . "</span> " . tsd_get_coauthors_link_for_post($post) . "</div>" : "";
