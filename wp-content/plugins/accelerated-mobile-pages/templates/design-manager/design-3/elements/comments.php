									...
									<footer class="comment-meta">
									   <?php if($comment_author_img_url){ ?>
										...
										<div class="comment-author vcard">
											<?php  printf(__('<b class="fn">%s</b> <span class="says">'.esc_attr(ampforwp_translation($redux_builder_amp['amp-translator-says-text'],'says').':').'</span>'), get_comment_author_link()) ?>
										</div>
										<!-- .comment-author -->
