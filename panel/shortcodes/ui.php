...
<form id="GalleryShortcode">
	<p>
		<label for="VideoUrl" style="width:230px">Video Url :</label>
		<input id="VideoUrl" name="VideoUrl" type="text" value="http://" />
		<br /><small>supports : YouTube, Vimeo, Viddler, Qik, Hulu, FunnyOrDie, DailyMotion, WordPress.tv and blip.tv</small>
	</p>
	<p>
